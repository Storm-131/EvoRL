# ---------------------------------------------------------*/
# Full configuration for testing code
# ---------------------------------------------------------*/
...
TRAIN_PPO_AGENT = 1          # (1/0) Train PPO agent from scratch

RUN_CMA_TUNING = 1           # (1/0) Run CMA-ES hyperparameter tuning
...
TRAIN_PPO_CMA = 1            # (1/0) Train PPO after CMA-ES pretraining (BC warm-start)
...
# ---------------------------------------------------------*/
BENCHMARK_N_SEEDS = 20        # Number of seeds for benchmarking
...
CMA_BATCH_NUM_ENVS = 100             # Number of parallel envs for batch CMA-ES
